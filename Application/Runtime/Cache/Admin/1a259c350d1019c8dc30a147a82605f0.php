...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="index.html">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">碎语碎语列表</span></div>
        </div>
                ...
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        ...
                        <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td title="发哥经典"><a target="_blank" href="#" title="发哥经典"><?php echo ($v["content"]); ?></a> …
                            </td>
                            <td><?php echo ($v["time"]); ?></td>
                            <td>
                                <a class="link-update" href="/zyblog/index.php/Admin/Moodlist/edit/id/<?php echo ($v["id"]); ?>">修改</a>
                                <a class="link-del" href="/zyblog/index.php/Admin/Moodlist/del/id/<?php echo ($v["id"]); ?>">删除</a>
                            </td>
