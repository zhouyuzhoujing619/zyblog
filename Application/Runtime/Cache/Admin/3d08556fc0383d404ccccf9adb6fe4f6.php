    ...
    <div class="main-wrap">
        ...
        <div class="search-wrap">
            <div class="search-content">
                <form class="form-horizontal" action="/zyblog/index.php/Admin/Moodlist/add" method="post">
        ...
        <tr>
            ...
            <td>
             <script type="text/javascript">
                ...
                <input  style="width:300px;background: #fefefe;border: 1px solid #bbb;font-size: 14px;color: #333;padding: 7px;border-radius: 3px;" type="text" class="date_picker" name="time" >
             </td> 
        </tr>
        <tr>
            <th><b>内容</b></th>
