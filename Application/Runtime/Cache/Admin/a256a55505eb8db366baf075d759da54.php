...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="index.html">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">回复评论</span></div>
        </div>
    ...
    <tr>
        ...
        <tr>
            <th><b>内容</b></th>
            <td>
                <textarea class="form-control" name="zhaiyao" rows="6" style="width:500px;" ><?php echo ($data['comment']); ?></textarea>
            </td>
        </tr>
        <tr>
            <th><b>回复</b></th>
