    ...
    <div class="main-wrap">
        ...
        <div class="search-wrap">
            <div class="search-content">
                <form class="form-horizontal" action="{U:('Admin/Article/index')}" method="post">
    <table class="search-tab" width="100%">
        <tr>
            <th width="80px"><b>所属分类</b></th>
            <td >
                <select class="form-control" name="fenlei" width="200px">
                        <option value="id">学习</option>
                        <option value="id">生活</option>
                </select>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>
             <script type="text/javascript">
                ...
                <input  style="width:290px;background: #fefefe;border: 1px solid #bbb;font-size: 14px;color: #333;padding: 7px;border-radius: 3px;" type="text" class="date_picker">
             </td> 
        </tr>
        <tr>
            <th><b>作者</b></th>
