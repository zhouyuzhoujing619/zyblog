...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        ...
        <div class="search-wrap">
            <div class="search-content">
                <form class="form-horizontal" action="/zyblog/Admin/Article/update" method="post">
    ...
    <tr>
        ...
        <tr>
            ...
            <td >
                <input class="form-control" type="text" name="fenlei" style="width:300px;height:25px" placeholder="学习/生活" value="<?php echo ($data['fenlei']); ?>">
            </td>
        </tr>
        <tr>
            <th><b>标题</b></th>
            <td >
                <input class="form-control" type="text" name="title" style="width:300px;height:25px" value="<?php echo ($data['title']); ?>">
            </td>
        </tr>
        <!-- <tr>
            <th><b>上传时间</b></th>
            <td>
             <script type="text/javascript">
                ...
                <input  style="width:290px;background: #fefefe;border: 1px solid #bbb;font-size: 14px;color: #333;padding: 7px;border-radius: 3px;" type="text" class="date_picker" name="time">
             </td> 
        </tr> -->
        <tr>
            <th><b>作者</b></th>
            <td>
                <input class="form-control" type="text" name="author"  style="width:300px;height:25px" value="<?php echo ($data['author']); ?>">
            </td>
        </tr>
        <tr>
            <th><b>摘要</b></th>
            <td>
                <textarea class="form-control" name="zhaiyao" rows="6" style="width:500px;" ><?php echo ($data['zhaiyao']); ?></textarea>
            </td>
        </tr>
        <tr>
            <th><b>内容</b></th>
            <td>
                  <script id="editor" name="content" type="text/plain" style="width:90%;" ><?php echo ($data['content']); ?></script>
            </td>
        </tr>
        <tr>
            <th><b>是否原创</b></th>
